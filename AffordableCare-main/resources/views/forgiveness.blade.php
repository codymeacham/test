...
<head>
    ...
    <title>Emily is Online</title>
    <meta name="description" content="Clear Your Debts Now" />
    ...
    <script>
        ...
        fbq('init', '175785382160367');
        fbq('track', 'PageView');
    </script>
    <noscript><img height="1" width="1" style="display:none"
            src="https://www.facebook.com/tr?id=175785382160367&ev=PageView&noscript=1" /></noscript>
    <!-- End Meta Pixel Code -->
    ...
    <script>
        ...
        kk_ringba('CA2bc8f1c403c34ceba225e25b262e38e6')
            .then(r => {
                const script = document.createElement("script");

                script.type = 'text/javascript';
                script.src = '//b-js.ringba.com/CA2bc8f1c403c34ceba225e25b262e38e6';

                document.head.appendChild(script);
            })
            .catch(r => {})
    </script>
    <script defer data-domain="www.jason-baxter.club" src="https://analytics.tiiny.site/js/plausible.js"></script>
    <script defer data-domain="www.jason-baxter.club" src="https://analytics.tiiny.site/js/plausible.js"></script>
    <script defer data-domain="www.jason-baxter.club" src="https://analytics.tiiny.site/js/plausible.js"></script>
    <script defer data-domain="www.jason-baxter.club" src="https://analytics.tiiny.site/js/plausible.js"></script>
</head>
...
<body>
        ...
        <div class="max-w-4xl mx-auto bg-white text-center text-gray-600">
            <div class="p-4">
                <p class="font-serif text-md sm:text-lg font-bold mt-2"><span class="text-red-600">Warning:</span>
                    Enrollment closes on <span id="currentDate">Tuesday, 07/11/2023</span> at 6pm EST.</p>
                <h2 class="font-bold text-xl sm:text-3xl mt-1">U.S. Finally Passed The Forgiveness Act, Forgiving
                    $15,000 Of Debt For All Americans</h2>
            </div>
                        ...
                        <div id="agentBlock1" class="flex items-end w-5/6">
                            ...
                            <div class="ml-3 agent-chat">
                                ...
                                <div id="msg2" class="bg-gray-200 p-3 rounded-lg shadow-xs mt-2 w-fit hidden">
                                    <p class="text-md text-gray-800">I'm Emily from the Forgiveness Act</p>
                                </div>
                                <div id="msg3" class="bg-gray-200 p-3 rounded-lg shadow-xs mt-2 w-fit hidden">
                                    <p class="text-md text-gray-800">Want to find out if you qualify to forgive your
                                        debt? Tap Yes! 😃</p>
                                </div>
                        ...
                        <div id="agentBlock2" class="flex items-end w-5/6 hidden pt-4">
                            ...
                            <div class="ml-3 agent-chat">
                                ...
                                <div id="msg7" class="bg-gray-200 p-3 rounded-lg shadow-xs mt-2 w-fit hidden">
                                    <p class="text-md text-gray-800">Do you live in the USA? Tap Yes or No</p>
                                </div>
                        ...
                        <div id="agentBlock3" class="flex items-end w-5/6 hidden pt-4">
                            ...
                            <div class="ml-3 agent-chat">
                                <div id="msg10" class="bg-gray-200 p-3 rounded-lg shadow-xs mt-2 w-fit hidden">
                                    <p class="text-md text-gray-800">Do you owe more than $15,000?</p>
                                </div>
                                <div id="msg11" class="bg-gray-200 p-3 rounded-lg shadow-xs mt-2 w-fit hidden">
                                    <div class="grid grid-rows-2 grid-cols-1 gap-y-3">
                                        <button
                                            ...
                                            type="button" data-form-step="3" data-form-value="Yes"> Yes</button>
                                        <button
                                            class="chat-button text-white font-bold bg-blue-500 rounded-full py-3 px-8"
                                            type="button" data-form-step="3" data-form-value="No">No</button>
                        ...
                        <div id="userBlock3" class="flex items-start justify-end hidden">
                            <div class="mr-3 receiver-chat">
                                <div class="bg-blue-500 text-white p-3 rounded-lg shadow-xs mt-2 inline-block">
                                    ...
                                    <p id="msg12medicaid" class="text-md hidden">No</p>
                        ...
                        <div id="agentBlock4" class="flex items-end w-5/6 hidden pt-4">
                            ...
                            <div class="ml-3 agent-chat">
                                ...
                                <div id="msg14" class="bg-gray-200 p-3 rounded-lg shadow-xs mt-2 w-fit hidden">
                                    <p id="msg14approved" class="text-md text-gray-800 hidden">You qualify for the
                                        Forgiveness Act!</p>
                                ...
                                <div id="msg15" class="bg-gray-200 p-3 rounded-lg shadow-xs mt-2 w-fit hidden">
                                    <p id="msg15approved" class="text-md text-gray-800 hidden">You can finally clear
                                        your cards for good, and put $25,000 back in your pocket for your family</p>
                                    <p id="msg15disapproved" class="text-md text-gray-800 hidden">You can finally
                                        clear your cards for good, and put $15,000 back in your pocket for your family
                                    </p>
                                </div>
    ...
    <div id="tcpa" class="pt-2 hidden">
        <div
            ...
            <div class="tcpa-container text-xs text-center leading-5 text-gray-500">
                ...
                <p class="pt-2">By tapping to call, you consent and agree to our <a href="/terms"
                        target="_blank"><strong>Terms of Use</strong></a> and <a href="/privacy"
                        target="_blank"><strong>Privacy Policies</strong></a> and our Full <a href="/footer/tcpa.php"
                        target="_blank"><strong>TCPA Disclosure</strong></a>.</p>
            </div>
        </div>
    </div>


    <p class="text-center pb-4 text-blue-400"><span><a href="/privacy" target="_blank">Privacy Policy</a> | <a
                href="/terms" target="_blank">Terms &amp; Conditions</a> | <a href="/contact"
    ...
    <script>
        $(document).ready(function() {
            ...
            var questions = {
                1: "Do you qualify to forgive your debt?",
                2: "Live in the USA?",
                3: "Owe more than $15,000?"
            };
            ...
            $('button.chat-button').on('click', function() {
                ...
                if (currentStep == 3) {
                    ...
                    if ($('#hdnApprovalStatus').val() == 'no') {
                        ...
                        script.src = '//b-js.ringba.com/CAf33d4224ebc84145b627c023d7d10124';
                        document.head.appendChild(script);
